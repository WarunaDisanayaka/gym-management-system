...
// Retrieve the class name from the URL
$className = isset($_GET['class_name']) ? urldecode($_GET['class_name']) : '';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert the class booking into the database
    $memberId = $_SESSION["id"]; // Assuming you store the member ID in the session

    // Prepare and execute the SQL query
    $sql = "INSERT INTO class_bookings (class_name, booking_date, booking_time, phone, member_id)
            VALUES ('$className', '$bookingDate', '$bookingTime', '$phone', '$memberId')";
                     ...
                     <div class="card-body">
                        ...
                        <form action="#" method="post">
                           <div class="form-group">
                              ...
                              <input type="date" class="form-control" id="datepicker" placeholder="Select date" name="booking_date" required
                                 value="<?php echo isset($_GET['date']) ? htmlspecialchars(urldecode($_GET['date'])) : ''; ?>">
                           </div>
                           <div class="form-group">
                              <label for="timepicker">Select Time:</label>
                              <input type="time" class="form-control" id="timepicker" placeholder="Select time" name="booking_time" required
                                 value="<?php echo isset($_GET['time']) ? htmlspecialchars(urldecode($_GET['time'])) : ''; ?>">
                           </div>
                           <div class="form-group">
                              <label for="phone">Phone Number:</label>
                              <input type="tel" class="form-control" id="phone" placeholder="Enter your phone number" name="phone" required
                                 value="<?php echo isset($_GET['phone']) ? htmlspecialchars(urldecode($_GET['phone'])) : ''; ?>">
                           </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
                     ...
                     <p>Visit Us Today
                        Explore our website to learn more about our offerings, class schedules, membership options, and more. Join us today and embark on a journey to a healthier and more vibrant you. Contact us to schedule a tour, sign up for a class, or simply get more information. We can't wait to be part of your fitness journey!.
                     </p>
                  </div>
