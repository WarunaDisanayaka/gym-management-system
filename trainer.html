		...
		<div class="row">
			<div class="col-lg-6">
				<div class="card border-0 mb-1  bg-transparent rounded-0 mb-4">
				  <div class="row no-gutters align-items-center">
				    <div class="col-md-6">
				      <img src="images/team/team-6.png" alt="" class="img-fluid w-100">
				    </div>
				    <div class="col-md-6">
			...
			<div class="col-lg-6">
				<div class="card border-0 mb-1 bg-transparent  rounded-0 mb-4">
				  <div class="row no-gutters align-items-center">
				    <div class="col-md-6">
				      <img src="images/team/team-5.jpeg" alt="" class="img-fluid w-100">
				    </div>
				    <div class="col-md-6">
				      <div class="card-body team-wrap pl-4">
				        <h3 class="card-title text-color">Dinusha Lakmal</h3>
			...
			<div class="col-lg-6">
				<div class="card border-0 bg-transparent  rounded-0 mb-4 mb-lg-0">
				  <div class="row no-gutters align-items-center">
				    <div class="col-md-6">
				      <img src="images/team/team-9.jpeg" alt="" class="img-fluid w-100">
				    </div>
				    <div class="col-md-6">
				      <div class="card-body team-wrap pl-4">
				        <h3 class="card-title text-color">Achintha Imesh</h3>
				        
				        <p class="mb-5">Achintha Imesh is a certified fitness expert with 10 years of experience, focusing on strength training and nutrition. They're passionate about holistic fitness and dedicated to helping clients achieve a healthier lifestyle..</p>
			...
			<div class="col-lg-6">	
				<div class="card p-0 border-0 bg-transparent rounded-0">
				  <div class="row no-gutters align-items-center">
				    <div class="col-md-6 ">
				      <img src="images/team/team-8.jpeg" alt="" class="img-fluid w-100">
				    </div>
				    <div class="col-md-6">
				      <div class="card-body team-wrap pl-4">
				        <h3 class="card-title text-color">Dushan Malinga</h3>
				        
				        <p class="mb-5">Dushan Malinga is a seasoned fitness professional with a decade of expertise in strength training and nutrition. Committed to holistic wellness, they guide clients toward healthier living with enthusiasm and knowledge..</p>
