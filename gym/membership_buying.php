            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <b>Membership Buying Information</b>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php 
                                $i = 1;
                                $membershipBuyings = $conn->query("SELECT mb.*, m.username FROM membership_buying mb JOIN member m ON mb.user_id = m.id");
                                while($row = $membershipBuyings->fetch_assoc()):
                                ?>
                                <tr>
